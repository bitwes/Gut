...
func test_has_one_defaulted_parameter(_p=use_parameters(['a'])):
	assert_true(true, 'this one passes')

func test_has_two_parameters(_p1=null, _p2=null):
...
func test_does_not_use_use_parameters(_p=null):
...
class TestInnerClass:
	extends "res://addons/gut/test.gd"
	func test_inner_has_one_defaulted_parameter(_p=null):
		assert_true(true, 'this one passes')

	func test_inner_has_two_parameters(_p1=null, _p2=null):
		assert_true(false, 'Should not see this.  This should not be run.')
