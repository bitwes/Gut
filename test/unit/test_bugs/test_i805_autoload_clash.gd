...
class TestMakingScriptsWithOptionName:
	...
	# This fails, as it should.  Kept for future double checking parser behavior
	...
	# This fails, as it should.  Kept for future double checking parser behavior
	#func test_inner_class_of_existing_class_name_inside_a_class_name():
		#var src ="""
		#class_name ThisIsDifferentDoesItMatter
