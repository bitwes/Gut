...
var script1 = 'res://test/resources/parsing_and_loading_samples/test_samples.gd'
var script2 = 'res://test/resources/parsing_and_loading_samples/test_samples2.gd'
...
# # func test_printed_summary_uses_non_inner_class_as_script_count():
