...
.. table::
   ...
   +--------------------------------------------------------------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | |void|                                                                         | :ref:`assert_elapsed_time_almost_eq<class_GutTest_method_assert_elapsed_time_almost_eq>`\ (\ expected\: `float <https://docs.godotengine.org/en/stable/classes/class_float.html>`_, error_interval\: `float <https://docs.godotengine.org/en/stable/classes/class_float.html>`_, text\: `String <https://docs.godotengine.org/en/stable/classes/class_string.html>`_ = ""\ ) |
   +--------------------------------------------------------------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | |void|                                                                         | :ref:`assert_elapsed_time_eq<class_GutTest_method_assert_elapsed_time_eq>`\ (\ expected\: `float <https://docs.godotengine.org/en/stable/classes/class_float.html>`_, text\: `String <https://docs.godotengine.org/en/stable/classes/class_string.html>`_ = ""\ )                                                                                                            |
   +--------------------------------------------------------------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | |void|                                                                         | :ref:`assert_elapsed_time_gt<class_GutTest_method_assert_elapsed_time_gt>`\ (\ expected\: `float <https://docs.godotengine.org/en/stable/classes/class_float.html>`_, text\: `String <https://docs.godotengine.org/en/stable/classes/class_string.html>`_ = ""\ )                                                                                                            |
   +--------------------------------------------------------------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | |void|                                                                         | :ref:`assert_elapsed_time_lt<class_GutTest_method_assert_elapsed_time_lt>`\ (\ expected\: `float <https://docs.godotengine.org/en/stable/classes/class_float.html>`_, text\: `String <https://docs.godotengine.org/en/stable/classes/class_string.html>`_ = ""\ )                                                                                                            |
   +--------------------------------------------------------------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   ...
   +--------------------------------------------------------------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | `float <https://docs.godotengine.org/en/stable/classes/class_float.html>`_     | :ref:`get_elapsed_time<class_GutTest_method_get_elapsed_time>`\ (\ )                                                                                                                                                                                                                                                                                                         |
   +--------------------------------------------------------------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
...
.. _class_GutTest_method_get_elapsed_time:

.. rst-class:: classref-method

`float <https://docs.godotengine.org/en/stable/classes/class_float.html>`_ **get_elapsed_time**\ (\ ) :ref:`🔗<class_GutTest_method_get_elapsed_time>`
...
.. _class_GutTest_method_assert_elapsed_time_eq:

.. rst-class:: classref-method

|void| **assert_elapsed_time_eq**\ (\ expected\: `float <https://docs.godotengine.org/en/stable/classes/class_float.html>`_, text\: `String <https://docs.godotengine.org/en/stable/classes/class_string.html>`_ = ""\ ) :ref:`🔗<class_GutTest_method_assert_elapsed_time_eq>`

Assert that exactly ``expected`` seconds have elapsed since test method began.

.. rst-class:: classref-item-separator

----

.. _class_GutTest_method_assert_elapsed_time_almost_eq:

.. rst-class:: classref-method

|void| **assert_elapsed_time_almost_eq**\ (\ expected\: `float <https://docs.godotengine.org/en/stable/classes/class_float.html>`_, error_interval\: `float <https://docs.godotengine.org/en/stable/classes/class_float.html>`_, text\: `String <https://docs.godotengine.org/en/stable/classes/class_string.html>`_ = ""\ ) :ref:`🔗<class_GutTest_method_assert_elapsed_time_almost_eq>`

Assert that ``expected`` +/- ``error_interval`` seconds have elapsed since test method began.

.. rst-class:: classref-item-separator

----

.. _class_GutTest_method_assert_elapsed_time_lt:

.. rst-class:: classref-method

|void| **assert_elapsed_time_lt**\ (\ expected\: `float <https://docs.godotengine.org/en/stable/classes/class_float.html>`_, text\: `String <https://docs.godotengine.org/en/stable/classes/class_string.html>`_ = ""\ ) :ref:`🔗<class_GutTest_method_assert_elapsed_time_lt>`

Assert that less than ``expected`` seconds have elapsed since test method began.

.. rst-class:: classref-item-separator

----

.. _class_GutTest_method_assert_elapsed_time_gt:

.. rst-class:: classref-method

|void| **assert_elapsed_time_gt**\ (\ expected\: `float <https://docs.godotengine.org/en/stable/classes/class_float.html>`_, text\: `String <https://docs.godotengine.org/en/stable/classes/class_string.html>`_ = ""\ ) :ref:`🔗<class_GutTest_method_assert_elapsed_time_gt>`

Assert that greater than ``expected`` seconds have elapsed since test method began.
