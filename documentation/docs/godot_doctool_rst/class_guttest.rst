...
.. table::
   ...
   +--------------------------------------------------------------------------------+------------------------------------------------------------------------------------------------+---------------------------------------------+
   | `Variant <https://docs.godotengine.org/en/stable/classes/class_variant.html>`_ | :ref:`_compare<class_GutTest_property__compare>`                                               | ``new()``                                   |
   +--------------------------------------------------------------------------------+------------------------------------------------------------------------------------------------+---------------------------------------------+
   | :ref:`GutMain<class_GutMain>`                                                  | :ref:`gut<class_GutTest_property_gut>`                                                         | ``null``                                    |
   +--------------------------------------------------------------------------------+------------------------------------------------------------------------------------------------+---------------------------------------------+
   | `Variant <https://docs.godotengine.org/en/stable/classes/class_variant.html>`_ | :ref:`_disable_strict_datatype_checks<class_GutTest_property__disable_strict_datatype_checks>` | ``false``                                   |
   +--------------------------------------------------------------------------------+------------------------------------------------------------------------------------------------+---------------------------------------------+
   | `Variant <https://docs.godotengine.org/en/stable/classes/class_variant.html>`_ | :ref:`_fail_pass_text<class_GutTest_property__fail_pass_text>`                                 | ``[]``                                      |
   +--------------------------------------------------------------------------------+------------------------------------------------------------------------------------------------+---------------------------------------------+
   | `Variant <https://docs.godotengine.org/en/stable/classes/class_variant.html>`_ | :ref:`_summary<class_GutTest_property__summary>`                                               | ``{...}``                                   |
   +--------------------------------------------------------------------------------+------------------------------------------------------------------------------------------------+---------------------------------------------+
   | `Variant <https://docs.godotengine.org/en/stable/classes/class_variant.html>`_ | :ref:`_signal_watcher<class_GutTest_property__signal_watcher>`                                 | ``new()``                                   |
   +--------------------------------------------------------------------------------+------------------------------------------------------------------------------------------------+---------------------------------------------+
   ...
   +--------------------------------------------------------------------------------+------------------------------------------------------------------------------------------------+---------------------------------------------+
   | `Variant <https://docs.godotengine.org/en/stable/classes/class_variant.html>`_ | :ref:`_lgr<class_GutTest_property__lgr>`                                                       | ``get_logger()``                            |
   +--------------------------------------------------------------------------------+------------------------------------------------------------------------------------------------+---------------------------------------------+
   | `Variant <https://docs.godotengine.org/en/stable/classes/class_variant.html>`_ | :ref:`_strutils<class_GutTest_property__strutils>`                                             | ``new()``                                   |
   +--------------------------------------------------------------------------------+------------------------------------------------------------------------------------------------+---------------------------------------------+
   | `Variant <https://docs.godotengine.org/en/stable/classes/class_variant.html>`_ | :ref:`_awaiter<class_GutTest_property__awaiter>`                                               | ``null``                                    |
   +--------------------------------------------------------------------------------+------------------------------------------------------------------------------------------------+---------------------------------------------+
   ...
   +--------------------------------------------------------------------------------+------------------------------------------------------------------------------------------------+---------------------------------------------+
   | `Variant <https://docs.godotengine.org/en/stable/classes/class_variant.html>`_ | :ref:`_was_ready_called<class_GutTest_property__was_ready_called>`                             | ``false``                                   |
   +--------------------------------------------------------------------------------+------------------------------------------------------------------------------------------------+---------------------------------------------+
...
.. table::
   ...
   +--------------------------------------------------------------------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | |void|                                                                         | :ref:`_notification<class_GutTest_private_method__notification>`\ (\ what\: `Variant <https://docs.godotengine.org/en/stable/classes/class_variant.html>`_\ )                                                                                                                                                                                                                                                                                                                                                                                                                                            |
   +--------------------------------------------------------------------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | `Variant <https://docs.godotengine.org/en/stable/classes/class_variant.html>`_ | :ref:`_str<class_GutTest_private_method__str>`\ (\ thing\: `Variant <https://docs.godotengine.org/en/stable/classes/class_variant.html>`_\ )                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
   +--------------------------------------------------------------------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | `Variant <https://docs.godotengine.org/en/stable/classes/class_variant.html>`_ | :ref:`_str_precision<class_GutTest_private_method__str_precision>`\ (\ value\: `Variant <https://docs.godotengine.org/en/stable/classes/class_variant.html>`_, precision\: `Variant <https://docs.godotengine.org/en/stable/classes/class_variant.html>`_\ )                                                                                                                                                                                                                                                                                                                                             |
   +--------------------------------------------------------------------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | |void|                                                                         | :ref:`_fail<class_GutTest_private_method__fail>`\ (\ text\: `Variant <https://docs.godotengine.org/en/stable/classes/class_variant.html>`_\ )                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
   +--------------------------------------------------------------------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | |void|                                                                         | :ref:`_pass<class_GutTest_private_method__pass>`\ (\ text\: `Variant <https://docs.godotengine.org/en/stable/classes/class_variant.html>`_\ )                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
   +--------------------------------------------------------------------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | `Variant <https://docs.godotengine.org/en/stable/classes/class_variant.html>`_ | :ref:`_do_datatypes_match__fail_if_not<class_GutTest_private_method__do_datatypes_match__fail_if_not>`\ (\ got\: `Variant <https://docs.godotengine.org/en/stable/classes/class_variant.html>`_, expected\: `Variant <https://docs.godotengine.org/en/stable/classes/class_variant.html>`_, text\: `Variant <https://docs.godotengine.org/en/stable/classes/class_variant.html>`_\ )                                                                                                                                                                                                                     |
   +--------------------------------------------------------------------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | `Variant <https://docs.godotengine.org/en/stable/classes/class_variant.html>`_ | :ref:`_get_desc_of_calls_to_instance<class_GutTest_private_method__get_desc_of_calls_to_instance>`\ (\ inst\: `Variant <https://docs.godotengine.org/en/stable/classes/class_variant.html>`_\ )                                                                                                                                                                                                                                                                                                                                                                                                          |
   +--------------------------------------------------------------------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | `Variant <https://docs.godotengine.org/en/stable/classes/class_variant.html>`_ | :ref:`_fail_if_does_not_have_signal<class_GutTest_private_method__fail_if_does_not_have_signal>`\ (\ object\: `Variant <https://docs.godotengine.org/en/stable/classes/class_variant.html>`_, signal_name\: `Variant <https://docs.godotengine.org/en/stable/classes/class_variant.html>`_\ )                                                                                                                                                                                                                                                                                                            |
   +--------------------------------------------------------------------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | `Variant <https://docs.godotengine.org/en/stable/classes/class_variant.html>`_ | :ref:`_fail_if_not_watching<class_GutTest_private_method__fail_if_not_watching>`\ (\ object\: `Variant <https://docs.godotengine.org/en/stable/classes/class_variant.html>`_\ )                                                                                                                                                                                                                                                                                                                                                                                                                          |
   +--------------------------------------------------------------------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | `Variant <https://docs.godotengine.org/en/stable/classes/class_variant.html>`_ | :ref:`_get_fail_msg_including_emitted_signals<class_GutTest_private_method__get_fail_msg_including_emitted_signals>`\ (\ text\: `Variant <https://docs.godotengine.org/en/stable/classes/class_variant.html>`_, object\: `Variant <https://docs.godotengine.org/en/stable/classes/class_variant.html>`_\ )                                                                                                                                                                                                                                                                                               |
   +--------------------------------------------------------------------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | `Variant <https://docs.godotengine.org/en/stable/classes/class_variant.html>`_ | :ref:`_fail_if_parameters_not_array<class_GutTest_private_method__fail_if_parameters_not_array>`\ (\ parameters\: `Variant <https://docs.godotengine.org/en/stable/classes/class_variant.html>`_\ )                                                                                                                                                                                                                                                                                                                                                                                                      |
   +--------------------------------------------------------------------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | `Variant <https://docs.godotengine.org/en/stable/classes/class_variant.html>`_ | :ref:`_get_bad_double_or_method_message<class_GutTest_private_method__get_bad_double_or_method_message>`\ (\ inst\: `Variant <https://docs.godotengine.org/en/stable/classes/class_variant.html>`_, method_name\: `Variant <https://docs.godotengine.org/en/stable/classes/class_variant.html>`_, what_you_cant_do\: `Variant <https://docs.godotengine.org/en/stable/classes/class_variant.html>`_\ )                                                                                                                                                                                                   |
   +--------------------------------------------------------------------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | `Variant <https://docs.godotengine.org/en/stable/classes/class_variant.html>`_ | :ref:`_fail_if_not_double_or_does_not_have_method<class_GutTest_private_method__fail_if_not_double_or_does_not_have_method>`\ (\ inst\: `Variant <https://docs.godotengine.org/en/stable/classes/class_variant.html>`_, method_name\: `Variant <https://docs.godotengine.org/en/stable/classes/class_variant.html>`_\ )                                                                                                                                                                                                                                                                                  |
   +--------------------------------------------------------------------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | `Variant <https://docs.godotengine.org/en/stable/classes/class_variant.html>`_ | :ref:`_create_obj_from_type<class_GutTest_private_method__create_obj_from_type>`\ (\ type\: `Variant <https://docs.godotengine.org/en/stable/classes/class_variant.html>`_\ )                                                                                                                                                                                                                                                                                                                                                                                                                            |
   +--------------------------------------------------------------------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   ...
   +--------------------------------------------------------------------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | `bool <https://docs.godotengine.org/en/stable/classes/class_bool.html>`_       | :ref:`_is_almost_eq<class_GutTest_private_method__is_almost_eq>`\ (\ got\: `Variant <https://docs.godotengine.org/en/stable/classes/class_variant.html>`_, expected\: `Variant <https://docs.godotengine.org/en/stable/classes/class_variant.html>`_, error_interval\: `Variant <https://docs.godotengine.org/en/stable/classes/class_variant.html>`_\ )                                                                                                                                                                                                                                                 |
   +--------------------------------------------------------------------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   ...
   +--------------------------------------------------------------------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | `Variant <https://docs.godotengine.org/en/stable/classes/class_variant.html>`_ | :ref:`_find_object_property<class_GutTest_private_method__find_object_property>`\ (\ obj\: `Variant <https://docs.godotengine.org/en/stable/classes/class_variant.html>`_, property_name\: `Variant <https://docs.godotengine.org/en/stable/classes/class_variant.html>`_, property_usage\: `Variant <https://docs.godotengine.org/en/stable/classes/class_variant.html>`_ = null\ )                                                                                                                                                                                                                     |
   +--------------------------------------------------------------------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   ...
   +--------------------------------------------------------------------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | `Variant <https://docs.godotengine.org/en/stable/classes/class_variant.html>`_ | :ref:`_can_make_signal_assertions<class_GutTest_private_method__can_make_signal_assertions>`\ (\ object\: `Variant <https://docs.godotengine.org/en/stable/classes/class_variant.html>`_, signal_name\: `Variant <https://docs.godotengine.org/en/stable/classes/class_variant.html>`_\ )                                                                                                                                                                                                                                                                                                                |
   +--------------------------------------------------------------------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | `Variant <https://docs.godotengine.org/en/stable/classes/class_variant.html>`_ | :ref:`_is_connected<class_GutTest_private_method__is_connected>`\ (\ signaler_obj\: `Variant <https://docs.godotengine.org/en/stable/classes/class_variant.html>`_, connect_to_obj\: `Variant <https://docs.godotengine.org/en/stable/classes/class_variant.html>`_, signal_name\: `Variant <https://docs.godotengine.org/en/stable/classes/class_variant.html>`_, method_name\: `Variant <https://docs.godotengine.org/en/stable/classes/class_variant.html>`_ = ""\ )                                                                                                                                  |
   +--------------------------------------------------------------------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   ...
   +--------------------------------------------------------------------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | `Variant <https://docs.godotengine.org/en/stable/classes/class_variant.html>`_ | :ref:`_get_typeof_string<class_GutTest_private_method__get_typeof_string>`\ (\ the_type\: `Variant <https://docs.godotengine.org/en/stable/classes/class_variant.html>`_\ )                                                                                                                                                                                                                                                                                                                                                                                                                              |
   +--------------------------------------------------------------------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   ...
   +--------------------------------------------------------------------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | `Variant <https://docs.godotengine.org/en/stable/classes/class_variant.html>`_ | :ref:`_validate_singleton_name<class_GutTest_private_method__validate_singleton_name>`\ (\ singleton_name\: `Variant <https://docs.godotengine.org/en/stable/classes/class_variant.html>`_\ )                                                                                                                                                                                                                                                                                                                                                                                                            |
   +--------------------------------------------------------------------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   ...
   +--------------------------------------------------------------------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | |void|                                                                         | :ref:`_warn_for_public_accessors<class_GutTest_private_method__warn_for_public_accessors>`\ (\ obj\: `Variant <https://docs.godotengine.org/en/stable/classes/class_variant.html>`_, property_name\: `Variant <https://docs.godotengine.org/en/stable/classes/class_variant.html>`_\ )                                                                                                                                                                                                                                                                                                                   |
   +--------------------------------------------------------------------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   ...
   +--------------------------------------------------------------------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | `Variant <https://docs.godotengine.org/en/stable/classes/class_variant.html>`_ | :ref:`_smart_double<class_GutTest_private_method__smart_double>`\ (\ thing\: `Variant <https://docs.godotengine.org/en/stable/classes/class_variant.html>`_, double_strat\: `Variant <https://docs.godotengine.org/en/stable/classes/class_variant.html>`_, partial\: `Variant <https://docs.godotengine.org/en/stable/classes/class_variant.html>`_\ )                                                                                                                                                                                                                                                  |
   +--------------------------------------------------------------------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | `Variant <https://docs.godotengine.org/en/stable/classes/class_variant.html>`_ | :ref:`_are_double_parameters_valid<class_GutTest_private_method__are_double_parameters_valid>`\ (\ thing\: `Variant <https://docs.godotengine.org/en/stable/classes/class_variant.html>`_, p2\: `Variant <https://docs.godotengine.org/en/stable/classes/class_variant.html>`_, p3\: `Variant <https://docs.godotengine.org/en/stable/classes/class_variant.html>`_\ )                                                                                                                                                                                                                                   |
   +--------------------------------------------------------------------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
...
`Variant <https://docs.godotengine.org/en/stable/classes/class_variant.html>`_ **_compare** = ``new()`` :ref:`🔗<class_GutTest_property__compare>`
...
`Variant <https://docs.godotengine.org/en/stable/classes/class_variant.html>`_ **_disable_strict_datatype_checks** = ``false`` :ref:`🔗<class_GutTest_property__disable_strict_datatype_checks>`
...
`Variant <https://docs.godotengine.org/en/stable/classes/class_variant.html>`_ **_fail_pass_text** = ``[]`` :ref:`🔗<class_GutTest_property__fail_pass_text>`
...
`Variant <https://docs.godotengine.org/en/stable/classes/class_variant.html>`_ **_summary** = ``{...}`` :ref:`🔗<class_GutTest_property__summary>`
...
`Variant <https://docs.godotengine.org/en/stable/classes/class_variant.html>`_ **_signal_watcher** = ``new()`` :ref:`🔗<class_GutTest_property__signal_watcher>`
...
`Variant <https://docs.godotengine.org/en/stable/classes/class_variant.html>`_ **_lgr** = ``get_logger()`` :ref:`🔗<class_GutTest_property__lgr>`
...
`Variant <https://docs.godotengine.org/en/stable/classes/class_variant.html>`_ **_strutils** = ``new()`` :ref:`🔗<class_GutTest_property__strutils>`
...
`Variant <https://docs.godotengine.org/en/stable/classes/class_variant.html>`_ **_awaiter** = ``null`` :ref:`🔗<class_GutTest_property__awaiter>`
...
`Variant <https://docs.godotengine.org/en/stable/classes/class_variant.html>`_ **_was_ready_called** = ``false`` :ref:`🔗<class_GutTest_property__was_ready_called>`
...
|void| **_notification**\ (\ what\: `Variant <https://docs.godotengine.org/en/stable/classes/class_variant.html>`_\ ) :ref:`🔗<class_GutTest_private_method__notification>`
...
`Variant <https://docs.godotengine.org/en/stable/classes/class_variant.html>`_ **_str**\ (\ thing\: `Variant <https://docs.godotengine.org/en/stable/classes/class_variant.html>`_\ ) :ref:`🔗<class_GutTest_private_method__str>`
...
`Variant <https://docs.godotengine.org/en/stable/classes/class_variant.html>`_ **_str_precision**\ (\ value\: `Variant <https://docs.godotengine.org/en/stable/classes/class_variant.html>`_, precision\: `Variant <https://docs.godotengine.org/en/stable/classes/class_variant.html>`_\ ) :ref:`🔗<class_GutTest_private_method__str_precision>`
...
|void| **_fail**\ (\ text\: `Variant <https://docs.godotengine.org/en/stable/classes/class_variant.html>`_\ ) :ref:`🔗<class_GutTest_private_method__fail>`
...
|void| **_pass**\ (\ text\: `Variant <https://docs.godotengine.org/en/stable/classes/class_variant.html>`_\ ) :ref:`🔗<class_GutTest_private_method__pass>`
...
`Variant <https://docs.godotengine.org/en/stable/classes/class_variant.html>`_ **_do_datatypes_match__fail_if_not**\ (\ got\: `Variant <https://docs.godotengine.org/en/stable/classes/class_variant.html>`_, expected\: `Variant <https://docs.godotengine.org/en/stable/classes/class_variant.html>`_, text\: `Variant <https://docs.godotengine.org/en/stable/classes/class_variant.html>`_\ ) :ref:`🔗<class_GutTest_private_method__do_datatypes_match__fail_if_not>`
...
`Variant <https://docs.godotengine.org/en/stable/classes/class_variant.html>`_ **_get_desc_of_calls_to_instance**\ (\ inst\: `Variant <https://docs.godotengine.org/en/stable/classes/class_variant.html>`_\ ) :ref:`🔗<class_GutTest_private_method__get_desc_of_calls_to_instance>`
...
`Variant <https://docs.godotengine.org/en/stable/classes/class_variant.html>`_ **_fail_if_does_not_have_signal**\ (\ object\: `Variant <https://docs.godotengine.org/en/stable/classes/class_variant.html>`_, signal_name\: `Variant <https://docs.godotengine.org/en/stable/classes/class_variant.html>`_\ ) :ref:`🔗<class_GutTest_private_method__fail_if_does_not_have_signal>`
...
`Variant <https://docs.godotengine.org/en/stable/classes/class_variant.html>`_ **_fail_if_not_watching**\ (\ object\: `Variant <https://docs.godotengine.org/en/stable/classes/class_variant.html>`_\ ) :ref:`🔗<class_GutTest_private_method__fail_if_not_watching>`
...
`Variant <https://docs.godotengine.org/en/stable/classes/class_variant.html>`_ **_get_fail_msg_including_emitted_signals**\ (\ text\: `Variant <https://docs.godotengine.org/en/stable/classes/class_variant.html>`_, object\: `Variant <https://docs.godotengine.org/en/stable/classes/class_variant.html>`_\ ) :ref:`🔗<class_GutTest_private_method__get_fail_msg_including_emitted_signals>`
...
`Variant <https://docs.godotengine.org/en/stable/classes/class_variant.html>`_ **_fail_if_parameters_not_array**\ (\ parameters\: `Variant <https://docs.godotengine.org/en/stable/classes/class_variant.html>`_\ ) :ref:`🔗<class_GutTest_private_method__fail_if_parameters_not_array>`
...
`Variant <https://docs.godotengine.org/en/stable/classes/class_variant.html>`_ **_get_bad_double_or_method_message**\ (\ inst\: `Variant <https://docs.godotengine.org/en/stable/classes/class_variant.html>`_, method_name\: `Variant <https://docs.godotengine.org/en/stable/classes/class_variant.html>`_, what_you_cant_do\: `Variant <https://docs.godotengine.org/en/stable/classes/class_variant.html>`_\ ) :ref:`🔗<class_GutTest_private_method__get_bad_double_or_method_message>`
...
`Variant <https://docs.godotengine.org/en/stable/classes/class_variant.html>`_ **_fail_if_not_double_or_does_not_have_method**\ (\ inst\: `Variant <https://docs.godotengine.org/en/stable/classes/class_variant.html>`_, method_name\: `Variant <https://docs.godotengine.org/en/stable/classes/class_variant.html>`_\ ) :ref:`🔗<class_GutTest_private_method__fail_if_not_double_or_does_not_have_method>`
...
`Variant <https://docs.godotengine.org/en/stable/classes/class_variant.html>`_ **_create_obj_from_type**\ (\ type\: `Variant <https://docs.godotengine.org/en/stable/classes/class_variant.html>`_\ ) :ref:`🔗<class_GutTest_private_method__create_obj_from_type>`
...
`bool <https://docs.godotengine.org/en/stable/classes/class_bool.html>`_ **_is_almost_eq**\ (\ got\: `Variant <https://docs.godotengine.org/en/stable/classes/class_variant.html>`_, expected\: `Variant <https://docs.godotengine.org/en/stable/classes/class_variant.html>`_, error_interval\: `Variant <https://docs.godotengine.org/en/stable/classes/class_variant.html>`_\ ) :ref:`🔗<class_GutTest_private_method__is_almost_eq>`
...
`Variant <https://docs.godotengine.org/en/stable/classes/class_variant.html>`_ **_find_object_property**\ (\ obj\: `Variant <https://docs.godotengine.org/en/stable/classes/class_variant.html>`_, property_name\: `Variant <https://docs.godotengine.org/en/stable/classes/class_variant.html>`_, property_usage\: `Variant <https://docs.godotengine.org/en/stable/classes/class_variant.html>`_ = null\ ) :ref:`🔗<class_GutTest_private_method__find_object_property>`
...
`Variant <https://docs.godotengine.org/en/stable/classes/class_variant.html>`_ **_can_make_signal_assertions**\ (\ object\: `Variant <https://docs.godotengine.org/en/stable/classes/class_variant.html>`_, signal_name\: `Variant <https://docs.godotengine.org/en/stable/classes/class_variant.html>`_\ ) :ref:`🔗<class_GutTest_private_method__can_make_signal_assertions>`
...
`Variant <https://docs.godotengine.org/en/stable/classes/class_variant.html>`_ **_is_connected**\ (\ signaler_obj\: `Variant <https://docs.godotengine.org/en/stable/classes/class_variant.html>`_, connect_to_obj\: `Variant <https://docs.godotengine.org/en/stable/classes/class_variant.html>`_, signal_name\: `Variant <https://docs.godotengine.org/en/stable/classes/class_variant.html>`_, method_name\: `Variant <https://docs.godotengine.org/en/stable/classes/class_variant.html>`_ = ""\ ) :ref:`🔗<class_GutTest_private_method__is_connected>`
...
`Variant <https://docs.godotengine.org/en/stable/classes/class_variant.html>`_ **_get_typeof_string**\ (\ the_type\: `Variant <https://docs.godotengine.org/en/stable/classes/class_variant.html>`_\ ) :ref:`🔗<class_GutTest_private_method__get_typeof_string>`
...
`Variant <https://docs.godotengine.org/en/stable/classes/class_variant.html>`_ **_validate_singleton_name**\ (\ singleton_name\: `Variant <https://docs.godotengine.org/en/stable/classes/class_variant.html>`_\ ) :ref:`🔗<class_GutTest_private_method__validate_singleton_name>`
...
|void| **_warn_for_public_accessors**\ (\ obj\: `Variant <https://docs.godotengine.org/en/stable/classes/class_variant.html>`_, property_name\: `Variant <https://docs.godotengine.org/en/stable/classes/class_variant.html>`_\ ) :ref:`🔗<class_GutTest_private_method__warn_for_public_accessors>`
...
`Variant <https://docs.godotengine.org/en/stable/classes/class_variant.html>`_ **_smart_double**\ (\ thing\: `Variant <https://docs.godotengine.org/en/stable/classes/class_variant.html>`_, double_strat\: `Variant <https://docs.godotengine.org/en/stable/classes/class_variant.html>`_, partial\: `Variant <https://docs.godotengine.org/en/stable/classes/class_variant.html>`_\ ) :ref:`🔗<class_GutTest_private_method__smart_double>`
...
`Variant <https://docs.godotengine.org/en/stable/classes/class_variant.html>`_ **_are_double_parameters_valid**\ (\ thing\: `Variant <https://docs.godotengine.org/en/stable/classes/class_variant.html>`_, p2\: `Variant <https://docs.godotengine.org/en/stable/classes/class_variant.html>`_, p3\: `Variant <https://docs.godotengine.org/en/stable/classes/class_variant.html>`_\ ) :ref:`🔗<class_GutTest_private_method__are_double_parameters_valid>`
